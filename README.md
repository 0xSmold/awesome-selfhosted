...
- [SmoldPaper](https://smoldpaper.org) - Lightweight, zero-knowledge, self-hosted "burn after reading" secret stash. ([Source Code](https://github.com/0xSmold/smoldpaper)) `MIT` `PHP/JS`
...
- [Super Productivity](https://super-productivity.com) - Advanced todo list app with integrated timeboxing and time tracking capabilities. Integrates with Jira, GitHub, GitLab, Redmine and OpenProject. ([Source Code](https://github.com/johannesjo/super-productivity)) `MIT` `Docker`
